...
<body>
<div id="app">
    <div style="background-color: #fff; width: 150px; margin-top: 50px;">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a style="color=#fff; display: flex;" id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                            @switch($locale)
                                ...
                                @break
                                @case('kz')
                                <img style="width: 20px; margin-right: 10px;" src="{{asset('img/kz.png')}}"> {{__("Kazakh")}}
                                @break
                                @case('ru')
                        ...
                        <div style="color=#fff;" class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a style="display: flex;" class="dropdown-item" href="/kz"><img style="width: 20px; margin-right: 10px;" src="{{asset('img/kz.png')}}"> {{__("Kazakh")}}</a>
